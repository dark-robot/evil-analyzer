...
/**
 * Runtime exception throw at read a resource file
 *
 * @author dark.robot
 * @version 1.0.0
 * @since 1.0.0
...
public class LoaderException extends RuntimeException {
  ...
  /**
   * <p>
   * Constructs a new {@code LoaderException} with the specified detail message.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Constructs a new {@code LoaderException} with the specified detail message and cause.
   * </p>
