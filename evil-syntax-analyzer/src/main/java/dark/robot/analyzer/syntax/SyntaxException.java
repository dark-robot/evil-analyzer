...
public class SyntaxException extends RuntimeException{
  ...
  /**
   * <p>
   * Constructs a new {@code SyntaxException} with the specified detail message.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Constructs a new {@code SyntaxException} with the specified detail message and cause.
   * </p>
