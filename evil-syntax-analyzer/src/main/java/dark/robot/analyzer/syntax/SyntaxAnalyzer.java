 ...
 */
package dark.robot.analyzer.syntax;

import dark.robot.analyzer.common.analyzer.IAnalizer;
import org.springframework.stereotype.Service;

/**
 * Syntax analyzer start class
 *
 * @author dark.robot
 * @version 1.0.0
 * @since 1.0.0
 */
@Service(value = "syntaxAnalyzer")
public class SyntaxAnalyzer implements IAnalizer {

  /**
   * Constructs a {@code SyntaxAnalyzer} without arguments
   */
