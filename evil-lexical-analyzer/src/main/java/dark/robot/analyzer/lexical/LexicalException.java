...
public class LexicalException extends RuntimeException {
  ...
  /**
   * <p>
   * Constructs a new {@code LexicalException} with the specified detail message.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Constructs a new {@code LexicalException} with the specified detail message and cause.
   * </p>
